...
## Data Visualisation
Using Pandas, I made a table to see the overall details of the dataset. I saw that complicated had a very low sample count and decided to remove that variable because it might affect the result.
...
Relationship bar grpah with complicated category removed
